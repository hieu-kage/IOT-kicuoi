  ...
  return (
    <aside className="w-64 min-h-screen bg-sidebar-purple flex flex-col justify-between py-6 px-4 border-r border-purple-100 shrink-0">
      ...
      <div className="flex items-center gap-3 px-2 mt-auto">
        <div className="w-10 h-10 shrink-0 rounded-full border border-white bg-gradient-to-br from-primary-500 to-blue-400 flex items-center justify-center text-white font-semibold shadow-sm">
          LH
        </div>
        <div>
